...
gem "mr519_gen", # Motor de gestion de formularios y encuestas
  git: "https://gitlab.com/pasosdeJesus/mr519_gen.git", branch: "rails7.0fin"
  #path: "../mr519_gen"

gem "heb412_gen", # Motor de nube y llenado de plantillas
  git: "https://gitlab.com/pasosdeJesus/heb412_gen.git", branch: "rails7.0fin"
  #path: "../heb412_gen"

gem "sivel2_gen", # Motor para manejo de casos
  git: "https://gitlab.com/pasosdeJesus/sivel2_gen.git", branch: "rails7.0fin"
  #path: "../sivel2_gen"

gem "cor1440_gen",
  git: "https://gitlab.com/pasosdeJesus/cor1440_gen.git", branch: "rails7.0fin"
  #path: "../cor1440_gen"

gem "jos19",
  git: "https://gitlab.com/pasosdeJesus/jos19.git", branch: "rails7.0fin"
  #path: "../jos19"
