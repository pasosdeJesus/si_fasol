...
CREATE VIEW public.cvt1 AS
 SELECT DISTINCT acto.id_caso,
   ...
   FROM (((((((public.sivel2_gen_acto acto
     ...
     LEFT JOIN public.msip_ubicacion ubicacion ON ((caso.ubicacion_id = ubicacion.id)))
     LEFT JOIN public.msip_departamento departamento ON ((ubicacion.id_departamento = departamento.id)))
  WHERE (categoria.id = ANY (ARRAY[427, 297, 527, 777, 197, 397, 396, 196, 426, 526, 776, 296, 1025, 1023, 1070, 25, 45, 15, 55, 35, 73, 65, 92, 40, 50, 67, 801, 90, 46, 16, 26, 37, 57, 80, 85, 66, 64, 703, 18, 59, 706, 28, 49, 38, 501, 401, 904, 231, 17, 402, 502, 331, 705, 62, 906, 104, 713, 1021, 101, 76, 21, 11, 302, 903, 34, 27, 102, 902, 1060, 1050, 14, 301, 24, 20, 10, 30, 522, 292, 392, 422, 772, 192, 63, 93, 1024, 295, 425, 395, 775, 525, 195, 714, 78, 294, 424, 774, 524, 394, 194, 89, 1040, 1030, 905, 86, 701, 68, 241, 341, 1080, 141, 715, 704, 702, 33, 43, 13, 53, 23, 1010, 88, 98, 84, 709, 711, 707, 708, 710, 1003, 1005, 1000, 1001, 1002, 87, 97, 717, 917, 716, 916, 91, 95, 718, 393, 193, 773, 293, 423, 523, 48, 58, 75, 69, 41, 1004, 74, 36, 72, 22, 12, 56, 47, 1020, 391, 291, 771, 191, 421, 521, 77, 19, 39, 29, 520, 420, 712]));
