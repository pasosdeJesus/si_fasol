...
CREATE TABLE public.msip_persona (
    ...
    numerodocumento character varying(100) NOT NULL,
...
CREATE VIEW public.cvt1 AS
 SELECT DISTINCT acto.caso_id,
   ...
   FROM (((((((public.sivel2_gen_acto acto
     ...
     LEFT JOIN public.msip_ubicacion ubicacion ON ((caso.ubicacion_id = ubicacion.id)))
     LEFT JOIN public.msip_departamento departamento ON ((ubicacion.departamento_id = departamento.id)))
  WHERE (categoria.id = ANY (ARRAY[197, 297, 527, 397, 427, 777, 196, 526, 426, 776, 296, 1025, 1023, 1070, 25, 15, 55, 35, 73, 45, 65, 92, 40, 50, 67, 801, 90, 57, 37, 16, 46, 26, 80, 85, 66, 64, 703, 38, 706, 59, 28, 49, 18, 501, 401, 135, 125, 115, 904, 331, 231, 402, 502, 17, 705, 62, 403, 104, 503, 906, 713, 1021, 101, 302, 21, 11, 76, 34, 102, 903, 902, 27, 1060, 1050, 24, 14, 301, 30, 20, 10, 292, 192, 392, 422, 522, 772, 63, 93, 1024, 395, 425, 295, 525, 195, 775, 714, 78, 774, 194, 424, 524, 394, 294, 89, 1040, 1030, 905, 86, 701, 68, 141, 241, 1080, 341, 715, 704, 702, 13, 23, 53, 43, 33, 1010, 88, 98, 84, 709, 711, 707, 708, 710, 1003, 1005, 1000, 1001, 1002, 87, 97, 717, 917, 716, 916, 91, 95, 718, 193, 773, 393, 293, 423, 523, 48, 58, 75, 69, 41, 1004, 74, 72, 22, 36, 56, 47, 12, 1020, 391, 521, 771, 421, 291, 191, 520, 39, 29, 77, 420, 19, 712]));
 ...
 SELECT conscaso.caso_id,
  ...
  WHERE (conscaso.caso_id IN ( SELECT sivel2_gen_conscaso.caso_id
          ...
          WHERE ((sivel2_gen_conscaso.caso_id IN ( SELECT sivel2_gen_caso.id
                   FROM public.sivel2_gen_caso)) AND (sivel2_gen_conscaso.fecha >= '2013-01-01'::date) AND (sivel2_gen_conscaso.fecha <= '2013-12-31'::date))
...
ALTER TABLE ONLY public.sivel2_gen_antecedente_combatiente
    ADD CONSTRAINT antecedente_combatiente_id_antecedente_fkey1 FOREIGN KEY (antecedente_id) REFERENCES public.sivel2_gen_antecedente(id);
...
ALTER TABLE ONLY public.sivel2_gen_antecedente_combatiente
    ADD CONSTRAINT antecedente_combatiente_id_combatiente_fkey1 FOREIGN KEY (combatiente_id) REFERENCES public.sivel2_gen_combatiente(id);
...
ALTER TABLE ONLY public.sivel2_gen_antecedente_victima
    ADD CONSTRAINT antecedente_victima_id_victima_fkey FOREIGN KEY (victima_id) REFERENCES public.sivel2_gen_victima(id);
...
ALTER TABLE ONLY public.sivel2_gen_antecedente_victimacolectiva
    ADD CONSTRAINT antecedente_victimacolectiva_id_antecedente_fkey1 FOREIGN KEY (antecedente_id) REFERENCES public.sivel2_gen_antecedente(id);
...
ALTER TABLE ONLY public.sivel2_gen_filiacion_victimacolectiva
    ADD CONSTRAINT filiacion_victimacolectiva_id_filiacion_fkey1 FOREIGN KEY (filiacion_id) REFERENCES public.sivel2_gen_filiacion(id);
...
--
-- Name: msip_orgsocial fk_rails_1fa2bd3f4a; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.msip_orgsocial
    ADD CONSTRAINT fk_rails_1fa2bd3f4a FOREIGN KEY (subde_id) REFERENCES public.msip_orgsocial(id);
...
--
-- Name: sivel2_gen_caso_solicitud fk_rails_26cf51b19c; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_gen_caso_solicitud
    ADD CONSTRAINT fk_rails_26cf51b19c FOREIGN KEY (solicitud_id) REFERENCES public.msip_solicitud(id);
...
--
-- Name: msip_solicitud fk_rails_5eac714b59; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sivel2_gen_victima fk_rails_64844234a1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_gen_victima
    ADD CONSTRAINT fk_rails_64844234a1 FOREIGN KEY (cargoestado_id) REFERENCES public.cargoestado(id);
...
ALTER TABLE ONLY public.cor1440_gen_asistencia_opcioncaracterizacion
    ADD CONSTRAINT fk_rails_9349203984 FOREIGN KEY (opcioncaracterizacion_id) REFERENCES public.cor1440_gen_actividadpf(id);
...
--
-- Name: sivel2_gen_victima fk_rails_9ec85f7323; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sivel2_gen_victima
    ADD CONSTRAINT fk_rails_9ec85f7323 FOREIGN KEY (entidad_id) REFERENCES public.msip_orgsocial(id);
...
--
-- Name: sivel2_gen_caso_solicitud fk_rails_a952d537bf; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cor1440_gen_efecto_orgsocial fk_rails_aa4d8b3903; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cor1440_gen_efecto_orgsocial
    ADD CONSTRAINT fk_rails_aa4d8b3903 FOREIGN KEY (efecto_id) REFERENCES public.cor1440_gen_efecto(id);
...
--
-- Name: cor1440_gen_efecto_orgsocial fk_rails_bcdfdc8081; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cor1440_gen_efecto_orgsocial
    ADD CONSTRAINT fk_rails_bcdfdc8081 FOREIGN KEY (orgsocial_id) REFERENCES public.msip_orgsocial(id);
...
--
-- Name: cor1440_gen_actividad_orgsocial fk_rails_c24aae2dc3; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cor1440_gen_actividad_orgsocial
    ADD CONSTRAINT fk_rails_c24aae2dc3 FOREIGN KEY (orgsocial_id) REFERENCES public.msip_orgsocial(id);
...
ALTER TABLE ONLY public.usuario
    ADD CONSTRAINT fk_rails_cc8897078c FOREIGN KEY (tdocumento_id) REFERENCES public.msip_tdocumento(id);
...
--
-- Name: cor1440_gen_actividad_orgsocial fk_rails_da8fc6a5af; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cor1440_gen_actividad_orgsocial
    ADD CONSTRAINT fk_rails_da8fc6a5af FOREIGN KEY (actividad_id) REFERENCES public.cor1440_gen_actividad(id);
...
ALTER TABLE ONLY public.sivel2_gen_organizacion_victimacolectiva
    ADD CONSTRAINT organizacion_victimacolectiva_id_organizacion_fkey1 FOREIGN KEY (organizacion_id) REFERENCES public.sivel2_gen_organizacion(id);
...
ALTER TABLE ONLY public.sivel2_gen_profesion_victimacolectiva
    ADD CONSTRAINT profesion_victimacolectiva_id_profesion_fkey1 FOREIGN KEY (profesion_id) REFERENCES public.sivel2_gen_profesion(id);
...
ALTER TABLE ONLY public.sivel2_gen_rangoedad_victimacolectiva
    ADD CONSTRAINT rangoedad_victimacolectiva_id_rangoedad_fkey1 FOREIGN KEY (rangoedad_id) REFERENCES public.sivel2_gen_rangoedad(id);
...
ALTER TABLE ONLY public.sivel2_gen_sectorsocial_victimacolectiva
    ADD CONSTRAINT sectorsocial_victimacolectiva_id_sectorsocial_fkey1 FOREIGN KEY (sectorsocial_id) REFERENCES public.sivel2_gen_sectorsocial(id);
...
ALTER TABLE ONLY public.sivel2_gen_victimacolectiva_vinculoestado
    ADD CONSTRAINT victimacolectiva_vinculoestado_id_vinculoestado_fkey1 FOREIGN KEY (vinculoestado_id) REFERENCES public.sivel2_gen_vinculoestado(id);
